-- Session B: report incident after A holds the session lock.
...
select clock_timestamp() as session_b_before_incident;
select public.report_incident(
  '88700000-0000-0000-0000-00000000b001',
  current_setting('app.conc_session_id')::uuid,
  'Concurrent incident B'
) as session_b_incident_id;
select clock_timestamp() as session_b_after_incident;
commit;
