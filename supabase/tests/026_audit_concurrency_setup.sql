-- Two-connection report_incident setup. Commits so both connections can
-- see the started session.
...
begin
  ...
  update public.persons
     set first_name = 'Conc13B', last_name = 'Rider', date_of_birth = date '1990-01-01'
   where id = rider_person_id;
  update public.persons
     set first_name = 'Conc13B', last_name = 'Staff', date_of_birth = date '1985-01-01'
   where id = staff_person_id;
  update public.persons
     set first_name = 'Conc13B', last_name = 'Owner', date_of_birth = date '1975-01-01'
   where id = owner_person_id;

  insert into public.equestrian_centers (name, slug, country_code, status)
  values ('Phase13B Conc', 'phase13b-conc', 'ZY', 'ACTIVE')
  returning id into center_id;

  insert into public.equines (name, equine_type)
  values ('phase13b-conc-school', 'HORSE')
...
begin;
select set_config('request.jwt.claim.sub', '88700000-0000-0000-0000-000000000005', true);
select set_config(
  'request.jwt.claims',
  '{"sub":"88700000-0000-0000-0000-000000000005","role":"authenticated"}',
  true
);
select public.confirm_booking('88700000-0000-0000-0000-00000000b001') as confirmed_id;
commit;
...
select public.start_session('88700000-0000-0000-0000-00000000b001') as started_id;
commit;
